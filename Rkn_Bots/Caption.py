...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('🧑‍💻 Oᴡɴᴇʀ 🧑‍💻', url='https://t.me/JAsuran2p0'),
            types.InlineKeyboardButton('🎭 ʀᴇǫᴜᴇsᴛ 🎭', url='https://t.me/MovieKoodu1')
            ],[
            types.InlineKeyboardButton('🔥 Jᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 🔥', url='https://t.me/+enbcoW7Zebk2NmY9')
    ]]))
